 ...
 */
define(['N/search', '/SuiteScripts/BBE_LIB_GenericFunctionsSS2.js'], // jshint ignore:line

function(search, bbeLib) {
	...
	function getGrossProfitPercentAtLine(estimateId) {
		var estimateSearchObj = search.create({
			type : 'estimate',
			filters : [['type', 'anyof', 'Estimate'], 'AND', ['internalid', 'anyof', estimateId], 'AND', ['mainline', 'is', 'F'], 'AND', ['item.type', 'anyof', 'InvtPart', 'NonInvtPart']],

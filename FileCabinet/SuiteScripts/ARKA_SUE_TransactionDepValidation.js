    ...
    function beforeSubmit(scriptContext)
    {
        ...
        if (scriptContext.type == scriptContext.UserEventType.CREATE || scriptContext.type == scriptContext.UserEventType.EDIT) 
        {
            ...
            function validateDepartmentArea(departId, areaId, lineKey = 'On Main information', isHeader)
            {
                ...
                if (departId && validateDeptMessage.indexOf(lineKey) == -1 && Object.keys(areaDeptObj).length && areaId && areaDeptObj[departId] && areaDeptObj[departId].length && areaDeptObj[departId].indexOf(parseInt(areaId)) == -1)
                {

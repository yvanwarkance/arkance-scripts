 ...
 */
define(['N/ui/serverWidget', 'N/ui/message', 'N/record', 'N/search', 'N/format'], function (serverWidget, message, record, search, format) {
        ...
        if (context.type === context.UserEventType.VIEW ||
            ...
            var transactionSearch = search.create({
                ...
                columns: [
                    ...
                    search.createColumn({ name: 'custitem_end_of_life_date', join: 'item', summary: search.Summary.GROUP }),
            ...
            if (searchResultCount > 0) {
                ...
                pagedData.pageRanges.forEach(function (pageRange) {
                    ...
                    page.data.forEach(function (result) {
                        itemList += "<b>" + result.getValue({ name: 'itemid', summary: search.Summary.GROUP, join: 'item' }) + "</b>";
                        itemList += " (" + result.getValue({ name: 'custitem_end_of_life_date', summary: search.Summary.GROUP, join: 'item' }) + "), ";
                    });
                });
                ...
                if (refInFuture) {
                    msg = 'The following items used in this transaction are End of Life on or before the expected close date: ' + itemList;
                }

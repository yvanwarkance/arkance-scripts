...
<#if .locale = 'fr_FR'>
    <#assign labNRef = 'N/Réf.'/>
    <#assign labObjet = 'OBJET'/>
    <#assign labValidity = 'Validité'/>
    <#assign labLe = 'Le'/>
    <#assign txtline1 = 'Suite à notre conversation, veuillez trouver ci-joint notre offre financière pour votre projet.'/>
    <#assign txtline2 = 'Vous trouverez en annexe de cette offre le descriptif technique détaillé associé.'/>
    <#assign txtline3 = "Notre division dédiée Projets bénéficie des synergies créées entre les activités de terrain (bureau d'études, délégation, formation) et les activités d'ingénierie et de développement de la société. Cette spécificité nous permet d'avoir à la fois une expertise technique de pointe et une expérience concrète des métiers de nos clients."/>
    <#assign txtline4 = '25 ingénieurs d’application, 20 développeurs et 10 chefs de projet sont des atouts reconnus par Autodesk dans le cadre du label ATC Autodesk Training Center), ADN (Autodesk Authorized Developer)  et de notre certification Autodesk Platinum.'/>
    <#assign txtline5 = 'ARKANCE SYSTEMS dispose de la certification ISO 9001 (2015) pour l’ensemble de ses procédures de prestations.'/>
    <#assign txtline6 = 'Nous nous permettrons de vous contacter dans quelques jours pour vous fournir les informations complémentaires dont vous pourriez avoir besoin.'/> 
    <#assign txtline7 = "Nous vous prions d'agréer l'expression de nos salutations distinguées."/>
    <#assign labPCommerciale = 'Proposition Commerciale'/>
    <!-- <#assign labDescTech = 'Descriptif technique : se reporter au document joint en annexe'/> -->
    <#assign labQte = 'Qté'/>
    <#assign labRef = 'Réf.'/>
    <#assign labDesignation = 'Désignation'/>
    <#assign labMarque = 'Marque'/>
    <#assign labNotre = 'Notre'/>
    <#assign labOffre = 'Offre'/>
    <#assign labPrixUnit = "(Prix unitaire €HT)"/>
    <#assign labTotal = 'Total'/>
    <#assign labEuroHT = '€HT'/>
    <#assign labTotalHT = 'Montant total (€HT)'/>
    <#assign labTVA = 'TVA'/>
    <#assign labMontantTotal = "Montant total (TTC)"/>
    <#assign labPayCond = 'Conditions de paiement'/>
    ...
    <!-- <#assign labPlanning = 'Planning'/>
    <#assign txtline8 = 'Voir  descriptif technique joint'/> -->

    <#assign labGuarantee = 'Garantie'/>
    <#assign txtline9 = 'La garantie est de 1 mois après réception définitive'/>
    
    <#assign txtline10 = "L’assistance après la période de garantie ne fait pas partie de la présente offre."/>
    <#assign labAssurance = 'Assurance qualité'/>
    <#assign txtline11 = "Arkance Systems a obtenu et maintient depuis juin 2011 la certification ISO 9001 pour l’ensemble de ses services. <br />
        Le modèle d'assurance qualité mis en oeuvre pour cette prestation est celui en vigueur dans notre entreprise. <br />
        Le manuel qualité Arkance, réf : GE0077/MQ/QAL/001/B, est consultable en nos locaux"/>
    <#assign labAcceptOffer = "Pour acceptation de l'offre"/>
    <#assign labDate = 'Date'/>
    <#assign labNom = 'Nom'/>
    <#assign labPrenom = 'Prénom'/>
    <#assign labFonction = 'Fonction'/>
    <#assign labSig = 'Signature et tampon'/>
<#else>
    <#assign labNRef = 'N/Ref.'/>
    <#assign labObjet = 'Subject'/>
    <#assign labValidity = 'Validity'/>
    <#assign labLe = 'The'/>
    <#assign txtline1 = 'Following our conversation, please find attached our financial offer for your project.'/>
    <#assign txtline2 = 'You will find in the appendix to this offer the associated detailed technical description.'/>
    <#assign txtline3 = "Our dedicated Projects division benefits from the synergies created between field activities (design office, delegation, training) and the company's engineering and development activities. This specificity allows us to have both cutting-edge technical expertise and concrete experience of our clients' businesses."/>
    <#assign txtline4 = '25 application engineers, 20 developers and 10 project managers are assets recognized by Autodesk as part of the ATC Autodesk Training Center label, ADN (Autodesk Authorized Developer) and our Autodesk Platinum certification.'/>
    <#assign txtline5 = 'ARKANCE SYSTEMS has ISO 9001 (2015) certification for all of its service procedures.'/>
    <#assign txtline6 = 'We will contact you in a few days to provide you with any additional information you may need.'/> 
    <#assign txtline7 = "Please accept the expression of our distinguished greetings."/>
    <#assign labPCommerciale = "Commercial Proposal"/>
    <!-- <#assign labDescTech = "Technical description: refer to the attached document"/> -->
    <#assign labQte = 'Qty'/>
    <#assign labRef = 'Ref'/>
    <#assign labDesignation = 'Description'/>
    <#assign labMarque = 'Brand'/>
    <#assign labNotre = 'Our'/>
    <#assign labOffre = 'Offer'/>
    <#assign labPrixUnit = "(Unit Price €Excl. VAT)"/>
    <#assign labTotal = 'Total'/>
    <#assign labEuroHT = '€Excl. VAT'/>
    <#assign labTotalHT = 'Total Amount (€Excl. VAT)'/>
    <#assign labTVA = 'VAT'/>
    <#assign labMontantTotal = "Total Amount (Incl. VAT)"/>
    <#assign labPayCond = 'Payment Conditions'/>
    
    <!-- <#assign labPlanning = 'Planning'/>
    <#assign txtline8 = 'See attached technical description'/> -->
    
    <#assign labGuarantee = 'Guarantee'/>
    <#assign txtline9 = 'The warranty is 1 month after final receipt'/>
    
    <#assign txtline10 = "Support after the warranty period is not part of this offer."/>
    <#assign labAssurance = 'Quality assurance'/>
    <#assign txtline11 = "Arkance Systems has obtained and has maintained ISO 9001 certification since June 2011 for all of its services. <br />
        The quality assurance model implemented for this service is that in force in our company. <br />
        The Arkance quality manual, ref: GE0077/MQ/QAL/001/B, can be consulted at our premises"/>
    <#assign labAcceptOffer = 'For acceptance of the offer'/>
    <#assign labDate = 'Date'/>
    <#assign labNom = 'Name'/>
    <#assign labPrenom = 'First name'/>
    <#assign labFonction = 'Function'/>
    <#assign labSig = 'Signature and stamp'/>

    <#--  Variables to be used in the template (for the discount display logic - Bluebeam Project)  -->
    <#assign labDiscount = "Discount" />
    <#assign labTotalinWithoutDiscountBox='Total w/o discount (€Excl. VAT)' />
    <#assign labTotalinBox='Total (€Excl. VAT)' />
    <#assign labTAmount='Total Amount (€Excl. VAT)' />
    <#assign labAmountVAT='VAT (20%)' />
    <#assign labAmountInclVAT='Total amount incl. VAT (TTC)' />
	<#assign currency='€' />
</#if>
<pdf>
<head>
    ...
    <macrolist>
      ...
      <macro id="nlheader2">
            <table class="header" style="width: 100%;">
				<tr>
					<td rowspan="3">
						<p class="enrollment-form-ref-number"><span class="enrollment-form-ref-number-label">${labNRef} :</span>&nbsp;${record.tranid}</p>
					</td>
					<td rowspan="3">
						&nbsp;
					</td>
...
<body footer="nlfooter" footer-height="40pt" padding="0.5in 0.5in 0.5in 0.5in" size="Letter">
	...
	<table class="estimate-details">
		<tr> 
			<td class="reference-number"><span class="underline">${labNRef} :</span> ${record.tranid}</td>
		</tr>
		<tr>
			<td class="object"><span class="bold-underline">${labObjet} :</span> ${labPCommerciale}</td>
		</tr>
		<tr>
			<td class="location">${record.location}</td>
		</tr>
		<tr>
			<td class="validity">${labValidity} : ${record.custbody_validity_date}</td>
		</tr>
	</table>

	<p class="estimate-date">${labLe} ${record.trandate?string.medium}</p>
...
<p class="first-page-text">
  ${txtline7}
		 ...
		 <!-- TODO: Add Primary Contact Salutation -->
	</p>
      <br/>
	...
	<div class="estimate-title">
        ...
        <p class="proposition-commerciale">${labPCommerciale}</p>
		<!-- <p class="first-page-text">${labDescTech}</p> -->
	</div>
		...
		<table class="itemtable" style="width: 100%; margin-top: 10px;">
			...
			<#list record.item as item>
				<#if item_index == 0>
					<thead>
						<tr>
							<th class="item-table-header" align="center" width="5%">${labQte}</th>
							<th class="item-table-header" align="center" width="35%">${labRef}<br /><span class="item-table-subheader">${labDesignation}</span></th>
							<th class="item-table-header" align="center" width="6%">${labMarque}</th>
							<th class="item-table-header" align="center" width="10%">${labNotre} ${labOffre}<br /><span class="item-table-header-detail">${labPrixUnit}</span></th>
							<#--  5th cell  -->
                            ...
                            <th class="item-table-header" align="center" width="10%">${labTotal}<br /><span class="item-table-header-detail">${labEuroHT}</span></th>
						</tr>
					</thead>
				</#if>
				<tr>
					...
					<td class="item-table-item" align="left" width="35%"><span class="item-table-bold-item-ref">${item.item}</span><br />${item.description}</td>
	...
	<p class="payment-condition-label">${labPayCond} :</p>
	<p class="payment-condition-value">${record.terms}</p>

	<p class="training-text">
		<!-- <span class="training-bold-and-underlined">${labPlanning} :</span><br />
		<ul>
			<li>${txtline8}</li>
		</ul> -->
		<span class="training-bold-and-underlined">${labGuarantee}:</span><br /> 
        <ul>
			<li> ${txtline9} </li>
        <li> ${txtline10}  </li>
		</ul>
	...
	<p style="page-break-after: always;">
		<span class="training-bold-and-underlined">${labAssurance}:</span><br />
		<p class="first-page-text" >${txtline11}</p>
      <br/>
      <br/>
      <br/>
      <table class = "signature" style="width:40%;">
   <tr>
    <th class = "signature" style="text-align:center"></th>
  </tr>
  <tr>
    <th class = "signature-bold-italic" align="center">${labAcceptOffer}</th>
  </tr>
  <tr>
    <th class = "signature" align="center">${labDate}......../......../........</th>
  </tr>
  <tr>
    <th class = "signature" style="text-align:center"></th>
  </tr>
   <tr>
    <th class = "signature" style="text-align:center">${labNom}........................................................</th>
  </tr>
  <tr>
    <th class = "signature" style="text-align:center">${labPrenom}...................................................</th>
  </tr>
  <tr>
    <th class = "signature" style="text-align:center">${labFonction}..................................................</th>
  </tr>
  <tr>
    <th class = "signature" style="text-align:center"></th>
  </tr>
  <tr>
    <th class = "signature-bold-italic" align="center">${labSig}</th>
  </tr>
        <tr>
    <th class = "signature" style="text-align:center"></th>
  </tr>

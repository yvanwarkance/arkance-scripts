			...
			dropDownList.push(
				{
					...
					genid: 'custpage_contactmanager_selectfield', genName: 'Contract Manager Contact', isMandatory: false, isAddr: false, type: serverWidget.FieldType.SELECT
				}
			);
			...
			dropDownList.push(
				{
					...
					genid: 'custpage_contactperson_selectfield', genName: 'Contact Person', isMandatory: false, isAddr: false, type: serverWidget.FieldType.SELECT
				}
			);
		}
	}

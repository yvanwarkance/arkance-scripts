...
<body header="nlheader" header-height="10%" footer="nlfooter" footer-height="30pt" padding="0.1in 0.5in 0.4in 0.5in" size="letter">
  <table style="width: 100%; margin-top: 10px;padding-top: 20px;">
      <tr>
        <td style="font-size:24;padding-top: 2px;">${record.custbody_tran_printout_translation.custrecord_tran_invoice@label}</td>
      </tr>
  </table>
	...
	<tr>
      <td style="width: 55%;padding: 0">
        <table style="width: 100%;margin-top:30px;line-height:100%">
           <tr>
                <td width="35%">${record.custbody_tran_printout_translation.custrecord_tran_inv_number@label} :</td>
		...
		<td colspan="5" style="font-size:8;color:#40477E;border: 1px solid black;">
        	<#if .locale == "fr_FR">
         	...
         	<#else>
          	...
          	<br />
          	IBAN : ${subsidiary.custrecord_iban}<br />BIC/SWIFT : <span style="margin-left:6pt">${subsidiary.custrecord_bic}</span>
          </td>
       	<td style="width: 1%;"></td>

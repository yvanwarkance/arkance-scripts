 ...
 */
define(['N/log', 'N/ui/message', 'N/runtime'] /**
 * @param{log} log
 ...
 */, function (log, message, runtime) {
                ...
                currentRecord.setCurrentSublistValue({
                    ...
                    value:
                        column === 'isprimary'
                            ...
                            : column === 'contribution'
                              ? 100
                              : salesRepLineToSetAsPrimary[column],
    ...
    const postSourcing = async (scriptContext) => {
        ...
        if (isBlueBeamSalesConnected === 'Y' || isBlueBeamSalesConnected === 'N') {
            ...
            try {
                ...
                if (fieldId === 'entity') {
                    ...
                    const hasSalesRepBluebeam = salesRepEmployees.some(
                        (indivSalesRep) => indivSalesRep['salesrole'] === bluebeamSalesRole
                    )
                    ...
                    if (isBlueBeamSalesConnected === 'Y') {
                        ...
                        if (!hasSalesRepBluebeam) {
                            ...
                            // make sure to set up the "first" detected bluebeam sales rep as primary with 100% contribution
        ...
        } else if (errorWhenFetchingEmployeeClass) {
            // If there were any error that happened in the ARKA_SUE_BluebeamHandleDynamicSalesRep script, shows it
            const msg = message.create({
                type: ERROR,
                title: 'Error',

...
define(['N/query'], (query ) => {
    ...
    function pageInit(scriptContext) {
        ...
        {
            dropDownList.push(
                {nsfield: 'custbody_arka_adminmain', nsnextfield: 'custbody_arka_adminmain', sourcedfield: 'entity', 
                    genid: 'custpage_arka_adminmain', genName: 'Quote Admin', isMandatory: false, isAddr: false, type: DATATYPE.SELECT
                }
            );

            dropDownList.push(
                {nsfield: 'custbody_arka_recipientsmain', nsnextfield: 'custbody_arka_recipientsmain', sourcedfield: 'entity', 
                    genid: 'custpage_arka_recipientsmain', genName: 'Quote Recipients', isMandatory: false, isAddr: false, type: DATATYPE.MULTISELECT
                }
            );
        }

...
define(['N/record', 'SuiteScripts/BBE_LIB_GenericFunctionsSS2.js', 'N/search', 'N/format', 'N/ui/serverWidget', 'N/ui/message', 'N/runtime', 'N/email', 'N/query'], function (record, bbeLib, search, format, serverWidget, message, runtime, email, query) {
    ...
    function afterSubmit(scriptContext) {
        ...
        //ARK-323 - pending
        if (((currentRecord.type == 'estimate') && (scriptContext.type == scriptContext.UserEventType.CREATE || scriptContext.type == scriptContext.UserEventType.COPY)) && IsCreatedFromOpportunity) {
            record.submitFields({
 ...
 */
    function setEstimateFrom(createdFrom, currentRecord) {
        ...
        if (subsidiary && customForm) {
            ...
            var searchEstimate = search.create({
                ...
                columns:
                    [
                        search.createColumn({ name: 'custrecord_esti_form', label: 'Estimate Form' }),
                    ]
            });
    ...
    function beforeLoad(scriptContext) {
      ...
      if ((scriptContext.type == scriptContext.UserEventType.COPY || scriptContext.type == scriptContext.UserEventType.TRANSFORM || scriptContext.type == scriptContext.UserEventType.CREATE) && (currentRecord.type == 'opportunity' || currentRecord.type == 'estimate')) {
        ...
        if ((currentRecord.type == 'opportunity' || currentRecord.type == 'estimate') && (scriptContext.type === scriptContext.UserEventType.CREATE || scriptContext.type === scriptContext.UserEventType.EDIT) && (runtime.executionContext == runtime.ContextType.USER_INTERFACE)) {
        ...
        if ((currentRecord.type == 'estimate' || currentRecord.type == 'opportunity') && (scriptContext.type === scriptContext.UserEventType.VIEW)) {
        ...
        if ((scriptContext.type === scriptContext.UserEventType.CREATE || scriptContext.type === scriptContext.UserEventType.COPY) && currentRecord.type == 'estimate' && haveCreatedFrom) {
    ...
    function beforeSubmit(scriptContext) {
        ...
        if ((scriptContext.type == scriptContext.UserEventType.CREATE || scriptContext.type == scriptContext.UserEventType.EDIT) && (currentRecord.type == 'estimate' || currentRecord.type == 'opportunity')) {
